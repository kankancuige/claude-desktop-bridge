...
const messages: Record<Locale, Record<string, string>> = {
  ...
  chinese: {
    ...
    'tab.usage': '调用日志', 'tab.usage.desc': 'Token 用量与实时状态',
    ...
    // ────────────────────────────────────────────────────────────────────────
    'mem.scanning': '读取 PostgreSQL Memory...',
    'mem.emptyTitle': '当前没有项目 Memory',
    'mem.emptyHint1': 'Memory 正文、状态和索引统一保存在 PostgreSQL 中',
    'mem.emptyHint2': '本地 memory/*.md 仅用于兼容迁移，不参与正常读写',
    'mem.totalFiles': '共 {n} 条 Memory',
    'mem.refresh': '↻ 刷新',
    'mem.fileCount': '{n} 条记录',
    'mem.newPlaceholder': '新记忆文件名...',
    'mem.loadingFiles': '加载中...',
    'mem.noFiles': '暂无 Memory 记录，可在上方创建一条项目 Memory',
    'mem.confirmDelete': '确定删除 {name} ?',
    'mem.searchPlaceholder': '搜索标题、来源或内容...',
    'mem.search': '搜索',
    'mem.rebuild': '重建索引',
    'mem.rebuilding': '重建中...',
    'mem.indexReady': 'PostgreSQL 索引正常',
    'mem.fileMode': '文件副本/索引不可用',
    'mem.active': '已启用',
    'mem.disabled': '已停用',
    'mem.enable': '启用',
    'mem.disable': '停用',
  ...
  english: {
    ...
    'tab.usage': 'Usage log', 'tab.usage.desc': 'Token usage & live status',
    ...
    // ── Memory ──
    'mem.scanning': 'Reading PostgreSQL Memory...',
    'mem.emptyTitle': 'No project Memory yet',
    'mem.emptyHint1': 'Memory content, status, and indexes are stored in PostgreSQL',
    'mem.emptyHint2': 'Local memory/*.md files are migration-only compatibility files, not used for normal reads or writes',
    'mem.totalFiles': '{n} Memory records',
    'mem.refresh': '↻ Refresh',
    'mem.fileCount': '{n} records',
    'mem.newPlaceholder': 'New memory filename...',
    'mem.loadingFiles': 'Loading...',
    'mem.noFiles': 'No Memory records yet. Create a project Memory above.',
    ...
    'mem.indexReady': 'PostgreSQL index ready',
    'mem.fileMode': 'File copy / index unavailable',
    'mem.active': 'Enabled',
